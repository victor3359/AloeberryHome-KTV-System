...
# The now-playing/up-next/leaderboard markup (and its escapeHtml calls) moved into
# modules/player-core.js in slice 9; escapeHtml is imported there from session-ui.
