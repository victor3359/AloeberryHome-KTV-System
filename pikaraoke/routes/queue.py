...
def enqueue(query):
    ...
    user2 = request.args.get("user2") or None
    return _do_enqueue(query["song"], query["user"], user2)
...
def enqueue_form(form):
    ...
    user2 = request.form.get("song_added_by_2") or None
    return _do_enqueue(form["song_to_add"], form["song_added_by"], user2)
