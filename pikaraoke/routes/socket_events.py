...
def setup_socket_events(socketio):
    ...
    def handle_show_leaderboard() -> None:
        """Broadcast leaderboard data to all splash screens."""
        k = get_karaoke_instance()
        by_singer: dict = {}
    ...
    @socketio.on("hide_leaderboard")
    def handle_hide_leaderboard() -> None:
        """Tell all splash screens to hide the leaderboard."""
        socketio.emit("hide_leaderboard")
